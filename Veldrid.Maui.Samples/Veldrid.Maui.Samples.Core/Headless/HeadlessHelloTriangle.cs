...
void main()
{
    FragColor = vec4(1.0f, 0.5f, 0.2f, 1.0f);
        ...
        {
            var flipVertical = false;// GraphicsDevice.BackendType == GraphicsBackend.Vulkan;
            ...
            if (OperatingSystem.IsWindows() || OperatingSystem.IsMacCatalyst() || OperatingSystem.IsMacOS())
                File.WriteAllBytes(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, $"{nameof(HeadlessHelloTriangle)}.png"), imageData);
...
#endif
                File.WriteAllBytes(Path.Combine(path, $"{nameof(HeadlessHelloTriangle)}.png"), imageData);
            }
        }
#endregion
