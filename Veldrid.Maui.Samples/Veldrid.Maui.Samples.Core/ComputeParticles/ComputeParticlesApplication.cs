...
namespace Veldrid.Maui.Samples.Core.ComputeParticles
{
    public class ComputeParticlesApplication : BaseGpuDrawable
    {
        ...
        public ComputeParticlesApplication()
        {
        }
        ...
        {
            _cl.Begin();
            _cl.UpdateBuffer(_screenSizeBuffer, 0, new Vector4(PlatformInterface.Width, PlatformInterface.Height, 0, 0));
            ...
            for (int i = 0; i < ParticleCount; i++)
            {
                ParticleInfo pi = new ParticleInfo(
                    new Vector2((float)(r.NextDouble() * PlatformInterface.Width), (float)(r.NextDouble() * PlatformInterface.Height)),
        ...
        {
            base.OnViewResize();
            GraphicsDevice.UpdateBuffer(_screenSizeBuffer, 0, new Vector4(PlatformInterface.Width, PlatformInterface.Height, 0, 0));
        }
